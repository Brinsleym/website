...
content_blocks:
  ...
  - _bookshop_name: content
    content_html: >-
        ...
        <p>此外，我们仅设置一个名为<code>lang</code>的Cookie，用于记住您选择的语言（英语、日语或中文），以免网站将您从所选语言自动跳转到其他语言版本。该Cookie仅存储语言代码，不包含任何个人数据，不用于跟踪，有效期为一年。您可以随时在浏览器设置中删除它。</p>
        <p>我们不会通过其他网站或服务跟踪用户。</p>
